...
public class Blocks extends net.minecraft.block.Blocks {
    public static final SoakTableBlock SOAK_TABLE = registerBlock("soak_table", new SoakTableBlock(AbstractBlock.Settings.create().mapColor(MapColor.STONE_GRAY).instrument(Instrument.BASS).strength(3.0F).burnable()));
